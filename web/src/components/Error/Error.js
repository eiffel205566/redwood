...
const Error = ({ setIconType, setTypePageErrorState, setTypePageFormDesc }) => {
  const onSubmit = () => {
    setIconType((state) => {
  ...
  return (
    <div className="background bg-gray-100 absolute min-h-full min-w-full z-10 bg-opacity-50">
      <Form
        onSubmit={onSubmit}
